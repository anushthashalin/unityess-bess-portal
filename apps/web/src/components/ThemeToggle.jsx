...
export default function ThemeToggle() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className={cn(
          'absolute right-0 top-[calc(100%+6px)] z-50 w-44 rounded-xl shadow-2xl border overflow-hidden animate-fade-in',
          theme === 'dark'
          ...
          <div className={cn(
            ...
            theme === 'dark' ? 'text-white/30 border-white/06' : 'text-muted-foreground border-border/40'
          )}>
            Appearance
          </div>
          {THEMES.map(t => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className={cn('text-[10px] leading-tight', theme === 'dark' ? 'text-white/30' : 'text-muted-foreground')}>{t.desc}</div>
                </div>
                {isActive && (
